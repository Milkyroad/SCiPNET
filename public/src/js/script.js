import { loginConvert } from "./loginConvert.js";
import { sideBarFun } from "./sideBar.js";
import { appendError, appendWarn, appendNormal, scroll, cmdHide, cmdShow, btnHide, btnShow, addDot } from "./utils.js";
            ...
            .catch(function (error) {
                ...
                appendError(
                    `ERROR OCCURED: ${String(
                        error
                    ).toUpperCase()} YOUR ACCOUNT WAS SUCCESSFULLY CREATED OR UPDATED, BUT WE WERE UNABLE TO GENERATE A UNIQUE USERNAME FOR YOU. PLEASE TRY AGAIN LATER BY EDITING YOUR USERNAME.`
                );
                cmdShow();
                btnShow();
                registerState = 0;
                ...
                if (doc.exists) {
                    if (doc.data().Theme) {
                        ...
                        if (lockout == false) {
                            if (
                                defaultTheme != true &&
                                (localbackgroundColor != colorArray[0] || localcolor != colorArray[1] || localtextColor != colorArray[2] || localtextContrastColor != colorArray[3])
                            ) {
                                popUp(
                                    "NOTICE",
                                    `<blockquote>SCiPNET detected two theme versions, which one would you like to use?<br><div><span class="applicationBtn" id="option1">Local Version</span><span class="applicationBtn" id="option2">Server Version</span></div></blockquote>`
                                );
...
window.checkall = async function () {
    const proxies = [
        { domain: "https://cors.scipnet.workers.dev", url: "https://cors.scipnet.workers.dev/?" },
        { domain: "https://cors.milkyroady.workers.dev", url: "https://cors.milkyroady.workers.dev/?" },
        { domain: "https://api.codetabs.com", url: "https://api.codetabs.com/v1/proxy?quest=" },
        { domain: "https://api.allorigins.win", url: "https://api.allorigins.win/raw?url=" },
    ];

    for (let i = 0; i < proxies.length; i++) {
        try {
            await checkConnection(proxies[i].domain);
            link = proxies[i].url;
            return;
        } catch (error) {
            continue;
    ...
    switch (splitValue(val)[0]) {
        case "access":
            ...
            if (accessNo != undefined) {
                if (accessCl > 5 || accessCl < 0 || isNumber(accessCl) == false) {
                    ...
                    if (userLoggedIn) {
                        if (clearance < accessCl) {
                            ...
                            btnShow();
                            appendWarn(
                                `INSUFFICIENT SECURITY CLEARANCE. PLEASE ACCESS ANOTHER CLEARANCE LEVEL VERSION OF THE FILE. (Your current security clearance level is ${clearance}, however, you are trying to access a level ${accessCl} document)`
                            );
                        } else {
                ...
                btnShow();
                appendWarn(
                    "PLEASE ENTER THE SCP NUMBER OF THE DOCUMENT YOU WISH TO CONSULT<br><hr><small style='opacity:0.7'> Example: <b>access 173 </b><small>[SCP No. Required]</small> <b>5</b> <small>[Clearance Lvl. Optional]</small></small>"
                );
            }
            break;
        case "language":
            appendNormal(
                "<div>Please click and select the language of the SCP documentation you wish to access below:<ol class='languageSelect listClass'><li>Traditional Chinese</li><li>Simplified Chinese</li><li>Russian</li><li>Korean</li><li>French</li><li>Polish</li><li>Spanish</li><li>Thai</li><li>Japanese</li><li>German</li><li>Italian</li><li>Ukrainian</li><li>Portuguese</li><li>Czech</li><li>English</li></ol></div>"
            );
            $d.find(".languageSelect li")
                .unbind("click")
                .bind("click", function () {
                    var no = $(this).index() + 1;
                    $d.append($(this).text());
        ...
        case "login":
            if (userLoggedIn) {
                ...
                import(/*webpackChunkName:'login'*/ "./login.js").then((module) => {
                    ...
                    cmdShow();
                    appendNormal(
                        `<hr><span class="redLabels">Login Protocol initiated</span><br><span style="color:#98FB98">[✓] </span>Authentication request accepted at <span class="highlight">${new Date().toLocaleString(
                            "en-US"
                        )}</span>. Please enter your registered email for identity matching.<br><hr><small style='opacity:0.7'>Please enter your email address, you can always enter "Quit" to exit the login process</small>`
                    );
        ...
        case "control":
            ...
            popUp(
                `${displayTitle} Main Site Control Unit`,
                "<div class='pulse'></div><div class='loadText'>Loading Dashboard...<br><small>This might take a while depending on your internet speed</small></div>"
            );
        ...
        case "help":
            if (splitValue(val)[1] != undefined) {
                ...
                if (helpVal == "access") {
                    helpMess =
                        "Displays the Special Containment Procedures synopsis for a given artifact. Omitting the clearance level will automatically access the version of the file with the highest clearance level you own.";
        ...
        case "list":
            appendNormal(
                `<h3>List of accessible documents</h3><blockquote><p><span style="text-decoration: underline;">SCP by Series</span></p><ul style="list-style-type: none; padding: 0 10px;"><li><strong>I:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series">001-999</ele-access></li><li><strong>II:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-2">1000-1999</ele-access></li><li><strong>III:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-3">2000-2999</ele-access></li><li><strong>IV:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-4">3000-3999</ele-access></li><li><strong>V:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-5">4000-4999</ele-access></li><li><strong>VI:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-6">5000-5999</ele-access></li><li><strong>VII:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-7">6000-6999</ele-access></li></ul><p><span style="text-decoration: underline;">SCP Tales by Series</span></p><ul style="list-style-type: none; padding: 0 10px;"><li><strong>I:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-1-tales-edition">001-999</ele-access></li><li><strong>II:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-2-tales-edition">1000-1999</ele-access></li><li><strong>III:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-3-tales-edition">2000-2999</ele-access></li><li><strong>IV:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-4-tales-edition">3000-3999</ele-access></li><li><strong>V:</strong> <ele-access data-link="https://scp-wiki.wikidot.com//scp-series-5-tales-edition">4000-4999</ele-access></li></ul><p><span style="text-decoration: underline;">Other Useful Resources</span></p><ul style="list-style-type: none; padding: 0 10px;"><li><ele-access data-link="https://scp-wiki.wikidot.com//about-the-scp-foundation">About the Foundation</ele-access></li><li><ele-access data-link="https://scp-wiki.wikidot.com//object-classes">Object Classes</ele-access></li><li><ele-access data-link="https://scp-wiki.wikidot.com//personnel-and-character-dossier/noredirect/true">Personnel Dossier</ele-access></li><li><ele-access data-link="https://scp-wiki.wikidot.com//security-clearance-levels">Security &amp; Clearance</ele-access></li><li><ele-access data-link="https://scp-wiki.wikidot.com//secure-facilities-locations/noredirect/true">Secure Facilities</ele-access></li><li><ele-access data-link="https://scp-wiki.wikidot.com//task-forces/noredirect/true">Task Forces</ele-access></li><li><ele-access data-link="https://scp-wiki.wikidot.com//k-class-complete-list">K-Class Scenarios</ele-access></li></ul></blockquote>`
            );
            AccessLink();
            break;
        case "resetpass":
    ...
    if (lockout == false) {
        function changeCssVar() {
            ...
            $("#cmdIframe")
                ...
                .find("body")
                .add($("body"))
                .add($("#comIframe").contents().find("body"))
                .css({
                    "--defaultTheme": color,
...
function accessLoad(a, b) {
    if (init == false) {
        ...
        import(/*webpackChunkName:'access'*/ "./access.js").then((module) => {
    ...
    import(/*webpackChunkName:'lockout'*/ "./lockout.js").then((module) => {
        ...
        if (lockoutProcess == 1) {
            ...
            if (passLock == val) {
                ...
                module.unlock();
                appendNormal(
                    `Terminal unlocked, authorized by ${displayName} at <span class="highlight">${new Date().toLocaleString(
                        "en-US"
                    )} via SCiPNET ${displayLoc} SCP FOUNDATION PORTAL</span> [event no. ${Math.random().toString(36).slice(2).toUpperCase()}]`
                );
                lockoutProcess = 0;
            } else {
